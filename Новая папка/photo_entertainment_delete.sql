...
--
-- Структура таблицы `photo_entertainment_delete`
--

CREATE TABLE `photo_entertainment_delete` (
  `id` int(11) NOT NULL,
...
--
-- Индексы таблицы `photo_entertainment_delete`
--
ALTER TABLE `photo_entertainment_delete`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `photo_entertainment_delete`
--
ALTER TABLE `photo_entertainment_delete`
