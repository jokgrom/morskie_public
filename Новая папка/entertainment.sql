...
CREATE TABLE `entertainment` (
  `id` int(11) NOT NULL,
  `publicationStatus_id` int(5) NOT NULL DEFAULT 2,
  ...
  `prices` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- AUTO_INCREMENT для таблицы `entertainment`
--
ALTER TABLE `entertainment`
