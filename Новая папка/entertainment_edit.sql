...
--
-- Структура таблицы `entertainment_edit`
--

CREATE TABLE `entertainment_edit` (
  `id` int(11) NOT NULL,
...
--
-- Индексы таблицы `entertainment_edit`
--
ALTER TABLE `entertainment_edit`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `entertainment_edit`
--
ALTER TABLE `entertainment_edit`
