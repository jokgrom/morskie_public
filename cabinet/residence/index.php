		...
		<div class="wrap">
			...
			<div class="container">
				<div class="content">
					...
					<main class="main">
						<h1 class="title">Жильё | Опубликованные объявления</h1>
						<section class="section">
                            <p class="small">Размещайте объявления о посуточной сдаче жилья без посредников в нашем сервисе абсолютно бесплатно. Мы не берём плату за размещения или продления объявлений. Все клиенты связываются с вами на прямую. Объявления публикуются только с фотографиями! </p>
                            <p class="strong"><a href="/cabinet/residence/add/step1.php">Разместить объявление</a></p>
						</section>
