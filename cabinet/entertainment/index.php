...
<body>
	<div class="page page-publish myEntertainment">
		<div class="wrap">
			...
			<div class="container">
				<div class="content">
					...
					<main class="main">
						<h1 class="title">Развлечения | Опубликованные объявления</h1>
						<section class="section">
                            <p class="small">Размещайте объявления о развлечениях в нашем сервисе абсолютно бесплатно. Мы не берём плату за размещения или продления объявлений. Все клиенты связываются с вами на прямую. Объявления публикуются только с фотографиями!</p>
                            <p class="strong"><a href="/cabinet/entertainment/add/step1.php">Разместить объявление</a></p>
						</section>
						<?php  $MyEntertainment->getProduct($personId, 2); ?>
					</main>	
				</div>
			</div>
		</div>
