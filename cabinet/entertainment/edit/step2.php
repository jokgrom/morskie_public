<?php
    ...
    setcookie('lastEditEntertainmentId',$productId,time() + (3600*24*365),'/');//добавим ид последнего добавленного товара
?>
<!DOCTYPE html>
<html>
		...
		<div class="wrap">
			...
			<div class="container">
				<div class="content">
					...
					<main class="main">
						<h1 class="title">Редактирование фотографий | Развлечения</h1>
						<p>Объявление: <span class="color1 strong"><?php echo $Entertainment->title; ?></span></p>
                        ...
                        <section class="section">
                            <div id="box-img">
                                <?php echo $TemplateProduct->oldPhotoEntertainmentBox($personId, $productId, $UrlAdminStatus); ?>
                            </div>
                        </section>
                        <section>
