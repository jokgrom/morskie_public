<?php
    ...
    list  ($productId, $boolError, $textError)=$CleanFormProduct->id($_COOKIE['lastEditEntertainmentId']);
        ...
        foreach ($files as $file) {
            if (!empty($file['error']) || empty($file['tmp_name'])) {
                ...
                if (imagejpeg($image_p, $dir2 . $namePhoto .'.jpg', 79)) {
                    ...
                    $MyEntertainment->editPhoto2($personId, $productId, $namePhoto, $sizeWidth, $sizeHeight, $sizeBytes, $path);
                    $countPhoto++;
                    continue;
