...
<div class="page page-lord">
    <div class="wrap">
        ...
        <div class="container">
            <div class="content">
                <div class="left-bar">
                    <?php include_once($_SERVER['DOCUMENT_ROOT'].'/root/blocks/leftBar/lordRefusing.php');?>
                </div>
                <main class="main">
                    <h1 class="title">Отклонённые фотографии Развлечений</h1>
                    <section>
                        <div class="photo-block"><?php  $LordEntertainment->getPhoto_refusing();?></div>
                    </section>
                </main>
            </div>
        </div>
