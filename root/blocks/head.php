<?php
    ...
    switch ($url){
        ...
        case '/cabinet/authorization.php.php':
        ...
        case '/cabinet/registration.php':
            $pageInfo['title']='Регистрация. Разместить жилье на море бесплатно, быстро в Анапе, Сочи, Геленджик, Адлер';
